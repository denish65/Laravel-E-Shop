...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        // echo "<PRE> index function";print_r($products);exit();
    ...
    {
        // echo "<PRE> create function";print_r($request->all());exit();
    ...
    {
        // echo "<PRE> store function";print_r($request->all());exit();
        ...
        // echo "<PRE> pass validation ";print_r($request->all());exit();
